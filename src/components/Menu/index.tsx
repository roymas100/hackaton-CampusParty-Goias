...
const Menu: React.FC = () => {
  return <Flex w="285px" h="100vh" bgColor='#FFFFFF' flexDir='column' alignItems="center" pt='42px' pb='42px'>
    ...
    <Flex flexDir='column' w="100%" pt="16px" pb="16px" gap="16px">
...
return ( 
    <Flex position="relative" gap="8px" w="100%" height="36px" pl="60px" alignItems="center" opacity={active ? 1 : 0.5}>
